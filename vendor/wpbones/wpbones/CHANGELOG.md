...
- Added new [NSScottyPlugin-Database-Boilerplate](https://github.com/wpbones/NSScottyPlugin-Database-Boilerplate) example plugin.
...
- Updated and improved the [NSScottyPlugin Demo](https://github.com/wpbones/NSScottyPlugin) plugin.
...
- Added new [WP Bones API Boilerplate](https://github.com/wpbones/NSScottyPlugin-API-Boilerplate) example plugin.
- Added new [WP Bones Internationalization Boilerplate](https://github.com/wpbones/NSScottyPlugin-Internationalization-Boilerplate) example plugin.
- Added new [WP Bones Mantine Boilerplate](https://github.com/wpbones/NSScottyPlugin-Mantine-Boilerplate) example plugin.
- Added new [WP Bones ReactJS Boilerplate](https://github.com/wpbones/NSScottyPlugin-ReactJS-Boilerplate) example plugin.
- Added new [WP Bones Routes Boilerplate](https://github.com/wpbones/NSScottyPlugin-Routes-Boilerplate) example plugin.
...
- Updated the [WPBones demo plugin](https://github.com/wpbones/NSScottyPlugin).
- Updated the [WPBones Boilerplate plugin](https://github.com/wpbones/NSScottyPlugin-Boilerplate)
...
- In the [WPBones demo plugin](https://github.com/wpbones/NSScottyPlugin) and [WPBones Boilerplate plugin](https://github.com/wpbones/NSScottyPlugin-Boilerplate) we have renamed the `localization` folder to `languages`.
