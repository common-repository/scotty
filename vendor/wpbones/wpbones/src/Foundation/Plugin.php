...
namespace NSScottyPlugin\WPBones\Foundation;

use Closure;
use NSScottyPlugin\WPBones\Container\Container;
use NSScottyPlugin\WPBones\Contracts\Foundation\Plugin as PluginContract;
use NSScottyPlugin\WPBones\Database\WordPressOption;
use NSScottyPlugin\WPBones\Foundation\Http\Request;
use NSScottyPlugin\WPBones\Foundation\Log\LogServiceProvider;
use NSScottyPlugin\WPBones\Routing\AdminMenuProvider;
use NSScottyPlugin\WPBones\Routing\AdminRouteProvider;
use NSScottyPlugin\WPBones\Routing\API\RestProvider;
use NSScottyPlugin\WPBones\Routing\Pages\PageProvider;
use NSScottyPlugin\WPBones\Support\Str;
use NSScottyPlugin\WPBones\Support\Traits\HasAttributes;
use NSScottyPlugin\WPBones\View\View;
use NSScottyPlugin\WPBones\Database\Eloquent;
 ...
 * Main Plugin class.
 *
 * @package NSScottyPlugin\WPBones\Foundation
 */
class Plugin extends Container implements PluginContract
{
  ...
  {
    // simulate __FILE__
    $this->file = $this->basePath . '/scotty.php';
     ...
     * Description = "NSScottyPlugin is a WP Bones boilerplate plugin"
     * DomainPath = "languages"
     * Name = "NSScottyPlugin"
     * Network = false
     * PluginURI = "https://wpbones.com/"
     * TextDomain = "scotty"
     * Title = "NSScottyPlugin"
     * Version = "1.0.0"
     */
  ...
  public function getCallableHook($routes)
  {
    ...
    if (isset($controller) && isset($method)) {
      return function () use ($controller, $method) {
        $className = "NSScottyPlugin\\Http\\Controllers\\{$controller}";
