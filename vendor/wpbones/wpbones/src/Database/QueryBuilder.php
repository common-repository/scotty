...
namespace NSScottyPlugin\WPBones\Database;

use InvalidArgumentException;
use NSScottyPlugin\WPBones\Database\Support\Collection;
use NSScottyPlugin\WPBones\Database\Support\Model;
...
class QueryBuilder
{
   ...
   *
   * @var \NSScottyPlugin\WPBones\Database\Support\Collection
   */
  private $collection = [];
  ...
  */
   ...
   * @return \NSScottyPlugin\WPBones\Database\QueryBuilder
   */
